...
namespace OnlineTicariSite.Controllers
{
    public class IstatistikController : Controller
    {
        ...
        {   
            ...
            var deger13 = c.Uruns.Where(k => k.UrunId == (c.SatisHarekets.GroupBy(x => x.UrunId).OrderByDescending(z => z.Count()).Select(y => y.Key).FirstOrDefault())).Select(k => k.UrunAd).FirstOrDefault();
            ViewBag.d13 = deger13;
